...
namespace WMS.Infrastructure.Migrations
{
    ...
    [Migration("20260612074101_AddAnnouncementEmployees")]
    partial class AddAnnouncementEmployees
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WMS.Domain.Entities.AnnouncementEmployee", b =>
                {
                    b.Property<int>("AnnouncementId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WMS.Domain.Entities.Attendance", b =>
                {
                    ...
                    b.Property<double?>("TotalHours")
                        ...
                        .HasColumnType("FLOAT")
                        .HasComputedColumnSql("CAST((DATEDIFF(MINUTE, CheckIn, CheckOut)) / 60.0 AS FLOAT)", true);
            ...
            modelBuilder.Entity("WMS.Domain.Entities.Department", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            DepartmentId = 1,
                            CreatedOn = new DateTime(2026, 6, 12, 13, 11, 1, 12, DateTimeKind.Local).AddTicks(9762),
                        ...
                        {
                            DepartmentId = 2,
                            CreatedOn = new DateTime(2026, 6, 12, 13, 11, 1, 12, DateTimeKind.Local).AddTicks(9783),
                        ...
                        {
                            DepartmentId = 3,
                            CreatedOn = new DateTime(2026, 6, 12, 13, 11, 1, 12, DateTimeKind.Local).AddTicks(9784),
            ...
            modelBuilder.Entity("WMS.Domain.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            RoleId = 1,
                            Description = "Full system access — HR and system administration",
                            RoleName = "Admin"
                        },
                        new
                        {
                            RoleId = 2,
                            Description = "Team-scoped access — manages team leaves and project allocations",
                            RoleName = "Manager"
                        },
                        new
                        {
                            RoleId = 3,
                            Description = "Self-only access — own profile, attendance, and leaves",
                            RoleName = "Employee"
                        });
                });
            ...
            modelBuilder.Entity("WMS.Domain.Entities.AnnouncementEmployee", b =>
                {
                    b.HasOne("WMS.Domain.Entities.Announcement", "Announcement")
                        .WithMany("TargetEmployees")
